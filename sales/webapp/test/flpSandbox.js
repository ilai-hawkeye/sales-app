			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salessales-display": {
								"semanticObject": "salessales",
								"action": "display",
								"description": "A Sales Fiori application.",
								"title": "Sales",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sales.sales",
									"url": sap.ui.require.toUrl("sales/sales")
								}
							}
						}
					}
